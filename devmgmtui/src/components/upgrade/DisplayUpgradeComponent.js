...
class DisplayUpgradeComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      fileToAdd : null,
...
export default connect(mapStateToProps, actions)(DisplayUpgradeComponent);
