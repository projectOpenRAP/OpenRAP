...
if ($_SERVER['SERVER_NAME']!="$server_name.$domain_name") {
    ...
    if( (strpos($ser, "generate_204") == false) && (strpos($ser, "captive") == false)){
       // print "Not a Captive portal\n";
        ...
        header("location:http://$server_name.$domain_name");
...
if (cj) {
   // document.write("Hello All captive");
    ...
    document.write("<p>Congratulations! You are just one step away from free Education.<br> Download the <b>Pinut App</b> below to self learn (No data charges for you)..</p> <form method='GET'><input type='hidden' name='download'><input type='image' name='submit' value='Download App' src=\"public/images/android.png\" alt=\"Submit Form\"></form>");
