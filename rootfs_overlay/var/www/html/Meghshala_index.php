...
if ($_SERVER['SERVER_NAME']!="$server_name.$domain_name") {
    ...
    if( (strpos($ser, "generate_204") == false) && (strpos($ser, "captive") == false)){
       // print "Not a Captive portal\n";
        ...
        #header("location:https://play.google.com/store/apps/details?id=com.cloodon.meghshala");
        exit;
    }
    else {
        $captive = 1;
   ...
   // print $mac;
    ...
    if( strpos(file_get_contents($users),$mac) == false) {
      //  print "Mac $mac not Found";
        ...
        sleep(3);
        //header("location:http://app.pinut.in/public/pinut_static.apk");
        header("location:https://play.google.com/store/apps/details?id=com.cloodon.meghshala");
...
<section class="top-section"> 
       <div class="layout">            
            <article class="left-side">
                <h1 class="dpBlk logo"><a href="http://www.pinut.in"><img src="public/images/meghshala_logo.png" alt="Meghshala Logo"></a></h1>
                <!--<h2>Masti Ki <br> Meghshala</h2>-->
<script type="text/javascript">
var cj = whichAndroidV();
cj = 0;
if (cj) {
   // document.write("Hello All captive");
document.write("<p>For Free Movies, <b>Turn ON 3G/4G</b> connection and download <b>\"Pinut App\"</b> from Google Play Store<br><b> OR</b> <br><b>Turn OFF</b> your data connection (3G/4G) and open <b><u>app.pinut.in</u></b> from browser to download.</p>");
}
else {
    //document.write("Hi All NON-Captive");
    document.write("<p>Turn ON your 3G/4G connection to Download the <b>Meghshala App</b> from Play Store.<br><br>https://play.google.com/store/apps/details?id=com.cloodon.meghshala</p>");
