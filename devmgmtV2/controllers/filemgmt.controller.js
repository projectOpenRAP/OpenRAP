...
let deleteFileFromDisk = (req, res) => {
  ...
  if (ext === '.ecar') {
    ...
    // deletion of files outside the "/home/admin" dir and inside the "/home/admin/forwater" dir has been restricted.
    if((dir.startsWith('/home/admin')) && (!(dir.startsWith('/home/admin/forwater')))){
