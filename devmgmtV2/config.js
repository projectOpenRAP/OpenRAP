module.exports = {
	config : {
		...
		cloudAPI : {
			baseUrl : 'https://knowledge.forwater.in/api',
			searchUrlSuffix : '/content/v1/search',
			...
			authToken: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiI0NTAyNmQ0M2RhMWM0Yzc1OWMwNTNkZDA3OWJlMDkwMSJ9.bQ2Gie8C9eO7E-pcB0iICmf5uww2IuM8YgqR8ohZfTg',
			filter: {
				keysToUse: [
					'subject',
					'downloadUrl',
